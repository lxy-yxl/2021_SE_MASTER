...
public class ObjectServiceImpl extends ServiceImpl<ObjectMapper, Object> implements ObjectService {
    ...
    public Integer uploadObject(Integer user_id, String name, String description, Integer deposit, String tag, Integer rent_daily, String new_level, String url){
        ...
        {
            Integer object_id=object.getObjectId();
            Picture picture=new Picture();
            picture.setObjectId(object_id);
